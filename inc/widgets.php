...
class wildenstein_Ephemera_Widget extends WP_Widget {
	 ...
	 * @since cello-discovery 1.0
	 *
	 * @return wildenstein_Ephemera_Widget
	 */
	public function __construct() {
		parent::__construct( 'widget_twentyfourteen_ephemera', __( 'cello-discovery Ephemera', 'twentyfourteen' ), array(
