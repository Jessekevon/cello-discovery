<?php
/**
 * Template Name: Intermediate Classes
 *
 * @package WordPress
                ...
                <div class="col-xs-9">
                    ...
                    <section class="video-list">
                        <div class="row">
                            ...
                            <?php echo do_shortcode('[ajax_load_more id="videos" container_type="div" post_type="intermediate-video" posts_per_page="30" taxonomy="intermediate-videos" search="'. $term .'" taxonomy_terms="" taxonomy_operator="IN" scroll="false" order="ASC" orderby="title" transition="fade"]'); ?>
                        </div>
                    </section>
                </div>
            </div>
